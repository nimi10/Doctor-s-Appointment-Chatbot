...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Taniya Sharma", bg="RoyalBlue1", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="Kirti Bhardwaj", bg="RoyalBlue2", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam2.pack()
        self.lblTeam3=Label(self, text="Nimisha Sharma", bg="RoyalBlue3", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam3.pack()
        self.lblTeam4=Label(self, text="Gunjan Sharma", bg="RoyalBlue3", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam4.pack()
        self.lblTeam5=Label(self, text="Gunjan Thakur", bg="RoyalBlue3", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam5.pack()
